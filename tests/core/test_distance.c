...
static int test_euclidean_distance(void) {
    ...
    GV_Vector *v1 = vector_create_from_data(3, v1_data);
    GV_Vector *v2 = vector_create_from_data(3, v2_data);
    ASSERT(v1 != NULL, "v1 creation");
    ASSERT(v2 != NULL, "v2 creation");
    
    float dist = distance_euclidean(v1, v2);
    ...
    float dist_zero = distance_euclidean(v1, v1);
...
static int test_dot_product_distance(void) {
    ...
    float dist = distance_dot_product(v1, v2);
...
static int test_distance_mismatched_dimensions(void) {
    ...
    GV_Vector *v1 = vector_create_from_data(2, v1_data);
    GV_Vector *v2 = vector_create_from_data(3, v2_data);
    ASSERT(v1 != NULL, "v1 creation");
    ASSERT(v2 != NULL, "v2 creation");
