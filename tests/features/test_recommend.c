...
static int test_recommend_by_id_positive(void) {
    ...
    int n = recommend_by_id(db, positive_ids, 1, NULL, 0, 3, &config, results);
...
static int test_recommend_by_id_pos_neg(void) {
    ...
    GV_RecommendResult results[3];
    int n = recommend_by_id(db, positive_ids, 1, negative_ids, 1, 3, &config, results);
...
static int test_recommend_by_vector(void) {
    ...
    GV_RecommendResult results[3];
    int n = recommend_by_vector(db, positive_vecs, 1, NULL, 0,
...
static int test_recommend_by_vector_neg(void) {
    ...
    GV_RecommendResult results[3];
    int n = recommend_by_vector(db, positive_vecs, 1, negative_vecs, 1,
                                    DIM, 3, &config, results);
...
static int test_discover(void) {
    ...
    GV_RecommendResult results[3];
    int n = recommend_discover(db, target, context, DIM, 3, &config, results);
...
static int test_recommend_k_larger(void) {
    ...
    int n = recommend_by_id(db, positive_ids, 1, NULL, 0, 100, &config, results);
