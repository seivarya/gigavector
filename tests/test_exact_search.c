...
static int test_exact_knn_null_vectors(void) {
    ...
    int rc = gv_exact_knn_search_vectors(NULL, 10, &query, 3, results, GV_DISTANCE_EUCLIDEAN);
...
static int test_exact_knn_null_query(void) {
    ...
    GV_SearchResult results[3] = {0};
    int rc = gv_exact_knn_search_vectors(vectors, 2, NULL, 3, results, GV_DISTANCE_EUCLIDEAN);
...
static int test_exact_knn_zero_k(void) {
    GV_Vector query = { .dimension = DIM, .data = (float[]){1,0,0,0}, .metadata = NULL };
    GV_SearchResult results[3] = {0};
    int rc = gv_exact_knn_search_vectors(NULL, 0, &query, 0, results, GV_DISTANCE_EUCLIDEAN);
...
static int test_exact_knn_empty_database(void) {
    ...
    GV_SearchResult results[3] = {0};
    int rc = gv_exact_knn_search_vectors(vectors, 0, &query, 3, results, GV_DISTANCE_EUCLIDEAN);
...
static int test_exact_knn_basic(void) {
    ...
    GV_SearchResult results[3] = {0};
    int rc = gv_exact_knn_search_vectors(vectors, 3, &query, 2, results, GV_DISTANCE_EUCLIDEAN);
...
static int test_exact_knn_cosine(void) {
    ...
    int rc = gv_exact_knn_search_vectors(vectors, 2, &query, 2, results, GV_DISTANCE_COSINE);
...
static int test_exact_knn_k_limited(void) {
    ...
    int rc = gv_exact_knn_search_vectors(vectors, 1, &query, 5, results, GV_DISTANCE_EUCLIDEAN);
