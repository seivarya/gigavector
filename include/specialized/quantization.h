 ...
 * @param codes     Output buffer; must be at least quant_code_size() bytes.
 ...
 *
 * @param cb        Trained codebook.
 * @param codes     Encoded data (quant_code_size() bytes).
 * @param dimension Vector dimensionality (must match codebook).
 ...
 * @param dimension Vector dimensionality (must match codebook).
 * @return Squared Euclidean distance_compute(or Hamming for binary), or -1.0f on error.
 */
